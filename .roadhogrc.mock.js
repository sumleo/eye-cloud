...
const proxy = {
  ...
  'POST /api/forms': (req, res) => {
    res.send({ message: 'Ok', account: 'leore' });
  },
  'GET /api/my/getUserInformation': url,
  'POST /api/my/edit': url,
  'POST /api/report/submit': url,
  'GET /api/report/getReports': url,
